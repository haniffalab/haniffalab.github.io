        ...
        <Navbar expand="lg" className={scroll ? " navbar-sticky" : null}>
          <Container className="header">
            ...
            <Navbar.Collapse id="navbar-nav" className="justify-content-end">
              <Nav className="items me-4">
                <Nav.Link as={Link} to="/research" >Research</Nav.Link>
                <Nav.Link as={Link} to="/team" >Team</Nav.Link>
                <Nav.Link as={Link} to="/publications">Publications</Nav.Link>
                <Nav.Link as={Link} to="/" className="social"><FontAwesomeIcon icon={faTwitter} /></Nav.Link>
                <Nav.Link as={Link} to="/" className="social"><FontAwesomeIcon icon={faGithub} /></Nav.Link>
              </Nav>
                    ...
                    <div className="slide-content row">
                      <div className="col-12 d-flex inner">
                        <div className="center align-self-center text-center">
                          ...
                          <a href="#welcome" data-aos="zoom-out-up" data-aos-delay={1200} className="smooth-anchor ml-auto mr-auto mt-5 btn primary-button"><i className="icon-cup" />GET STARTED</a>
                        </div>
                      </div>
                    </div>
                  </div>

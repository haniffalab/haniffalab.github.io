...
import { update } from '../../features/breadcrumb/breadcrumbSlice'
...
const Study = () => {
  ...
  return (
    <div className="page-content">
      <Query query={STUDY_QUERY} slug={slug}>
        {({ data: { studies } }) => {
          dispatch(update(studies.data[0].attributes.name))
          return (
            <Container id="study">
              <Row className="justify-content-center pt-5">
                <Col className="section-title">
                  <h1 className="mb-4">{studies.data[0].attributes.name}</h1>
                  {studies.data[0].attributes.publications.data.map(function (d) {
                    return (
                      <div key={d.id}>
                        <p className="text-muted">
                          {d.attributes.journal.data.attributes.name}&nbsp;&#8226;&nbsp;
              ...
              <Row className="justify-content-center py-5">
                ...
                <Col lg={9}>
                  ...
                  <h2 id="dataset-header" className="my-5">Datasets</h2>
                  <Query
                    query={DONORS_QUERY}
                    pageIndex={1}
                    pageSize={2}
                  ...
                  <h2 id="sample-header" className="my-5">Samples</h2>
                  <Query
                    query={DONORS_QUERY}
                    pageIndex={1}
                    pageSize={2}
                  ...
                  <h2 id="code-software" className="mt-5">Software</h2>
                  ...
                  <h2 id="contributor-heading" className="mt-5">Contributors</h2>
